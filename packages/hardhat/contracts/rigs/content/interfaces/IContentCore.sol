 ...
 * @title IContentCore
 * @author heesho
 * @notice Interface for the ContentCore launchpad contract.
 */
interface IContentCore {
    ...
    function rigToMinter(address rig) external view returns (address);
    function rigToRewarder(address rig) external view returns (address);
